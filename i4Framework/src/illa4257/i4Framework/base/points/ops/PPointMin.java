...
public class PPointMin extends Point {
    private final Object locker = new Object();
    private volatile Point point1, point2;

    public PPointMin(final Point point1, final Point point2) {
        this.point1 = point1;
        this.point2 = point2;
    }
    ...
    public float calcFloat() {
        ...
        return Math.min(p1 != null ? point1.calcFloat() : 0, p2 != null ? point2.calcFloat() : 0);
    }
    ...
    public String toString() {
        return "PPointMin(" + point1 + ", " + point2 + ")";
    }
}