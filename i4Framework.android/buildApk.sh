...
libs=/home/illa4257/IdeaProjects/i4Language
...
${buildTools}/aapt2 compile -o ./compiled_res/ ./androidRes/**/*.xml

# Link resources with aapt2
${buildTools}/aapt2 link -o ./bin/app.unsigned.apk -I ${platform}/android.jar --manifest ./AndroidManifest.xml -R ./compiled_res/*.flat
